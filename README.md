...
SPA-приложение для заметок, выполненное на **Nuxt 4 (Composition API)** с использованием **Pinia**, **TypeScript** и **SCSS**.
...
- Все подтверждения через кастомные **модальные окна**.
